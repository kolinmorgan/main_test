<div class="wrapper container-fluid" >
    ...
    <div class="form-group" >
        ...
        <div class="col-xs-8">
            {!! Form::text('alias',$data['alias'],['class'=>'form-control','placeholder'=>'Введите название страницы']) !!}
        </div>
    </div>
    ...
    <div class="form-group" >
        ...
        <div class="col-xs-8">
            {!! Form::textarea('text',$data['text'],['id'=>'editor','class'=>'form-control','placeholder'=>'Введите название страницы']) !!}
        </div>
    </div>
    ...
    <div class="form-group" >
        ...
        <div class="col-xs-8">
            {!! Html::image('assets/img/'.$data['images'],'', ['class'=>'col-xs-2 control-label']) !!}
...
<!--    <div class="form-group" >
        {!! Form::label('link', 'Ссылка', ['class'=>'col-xs-2 control-label']) !!}
        <div class="col-xs-8">
            {!! Form::text('link',old('link'),['class'=>'form-control','placeholder'=>'Введите название страницы']) !!}
        </div>
    </div>-->
